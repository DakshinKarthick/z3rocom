  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] p-8">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-[#111113] border border-[#1a1a1f] rounded-lg p-6">
          <h2 className="text-lg font-bold text-[#fafafa] mb-2">How to Test</h2>
          <ol className="text-sm text-[#71717a] space-y-2 list-decimal list-inside">
            ...
            <li>In both windows, enter the SAME Session ID (get it from your active session URL)</li>
            ...
            <li>Check if the message appears in BOTH windows (realtime working!)</li>
          </ol>
        </div>
      </div>
    </div>
